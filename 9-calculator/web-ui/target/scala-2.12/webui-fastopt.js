...
$c_Lcalculator_CalculatorUI$.prototype.setupCalculator__V = (function() {
  ...
  var namedExpressions = $as_sc_TraversableOnce($f_sc_IterableLike__zip__sc_GenIterable__scg_CanBuildFrom__O(names, exprs, bf$3)).toMap__s_Predef$$less$colon$less__sci_Map($m_s_Predef$().singleton$und$less$colon$less$2);
  ...
  jsx$1.assert__Z__V($f_sc_GenSetLike__equals__O__Z(x, x$2));
  ...
  new $c_sc_TraversableLike$WithFilter().init___sc_TraversableLike__F1(namedValues, p).foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$5$1) {
    return (function(x$2$2$2) {
      ...
      if ((x$2$2 !== null)) {
        ...
        $m_Lcalculator_Signal$();
        var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, valueSignal$1, span$1, dehighlightTimeout$1) {
          return (function() {
            span$1.textContent = $objectToString(valueSignal$1.apply__O());
            span$1.style.backgroundColor = "#ffff99";
            var this$18 = $as_s_Option(dehighlightTimeout$1.elem$1);
            if ((!this$18.isEmpty__Z())) {
              var arg1$2 = this$18.get__O();
              $m_sjs_js_timers_package$().clearTimeout__sjs_js_timers_SetTimeoutHandle__V(arg1$2)
            };
            dehighlightTimeout$1.elem$1 = new $c_s_Some().init___O($m_sjs_js_timers_package$().setTimeout__D__F0__sjs_js_timers_SetTimeoutHandle(1500.0, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(this$2$1, span$1$1, dehighlightTimeout$1$1) {
              return (function() {
                dehighlightTimeout$1$1.elem$1 = $m_s_None$();
                span$1$1.style.backgroundColor = "white"
              })
            })($this, span$1, dehighlightTimeout$1))))
          })
        })(this$5$1, valueSignal, span, dehighlightTimeout));
        return new $c_Lcalculator_Signal().init___F0(expr)
      } else {
...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2, namedExpressions$1) {
    return (function(x$1$2) {
      var x$1 = $as_T2(x$1$2);
      if ((x$1 !== null)) {
        ...
        $m_Lcalculator_Signal$();
        var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this$1, namedExpressions$1$1, name$1, expr$1) {
          return (function() {
            return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(expr$1.apply__O()), $as_sci_Map(namedExpressions$1$1.$$minus__O__sc_Map(name$1)))
          })
        })(this$2, namedExpressions$1, name, expr));
  ...
  return $as_sci_Map(jsx$2.map__F1__scg_CanBuildFrom__O(jsx$1, new $c_scg_GenMapFactory$MapCanBuildFrom().init___scg_GenMapFactory(this$5)))
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      var denom = this.eval__Lcalculator_Expr__sci_Map__D(b$4, references);
      return ((denom === 0) ? (NaN) : (this.eval__Lcalculator_Expr__sci_Map__D(a$4, references) / denom))
    } else {
      throw new $c_s_MatchError().init___O(x1)
    }
  }
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, a$1, b$1, delta$1) {
    return (function() {
...
$c_Lcalculator_TweetLength$.prototype.tweetLength__p1__T__I = (function(text) {
  ...
  if ((text === "")) {
    ...
    var x = $as_T($f_sc_IndexedSeqOptimized__init__O(this$4));
    var this$9 = new $c_sci_StringOps().init___T(x);
    var jsx$2 = $m_s_Predef$();
    var this$7 = new $c_sci_StringOps().init___T(text);
    var that = jsx$2.wrapString__T__sci_WrappedString($as_T($f_sc_IndexedSeqOptimized__tail__O(this$7)));
    var this$8 = $m_s_Predef$();
    var bf = new $c_s_LowPriorityImplicits$$anon$4().init___s_LowPriorityImplicits(this$8);
    var jsx$1 = $as_sc_TraversableOnce($f_sc_IndexedSeqOptimized__zip__sc_GenIterable__scg_CanBuildFrom__O(this$9, that, bf));
    var this$15 = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function($this) {
    ...
    return ((jsx$3 - jsx$1.count__F1__I($f_F2__tupled__F1(this$15))) | 0)
  }
});
